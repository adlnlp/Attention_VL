...
def parseArgs():
    ...
    parser.add_argument("--dataBasedir",     default = "/content/drive/MyDrive/MAC/mac-network", type = str,            help = "data base directory") # /jagupard14/scr1/dorarad/
    ...
    parser.add_argument("--control_element_wise_multiply",      action = "store_true",          help = "original methal") 
    parser.add_argument("--control_general_kwq",                action = "store_true",          help = "general KWQ") 
    parser.add_argument("--control_dot",                        action = "store_true",          help = "dot-product") 
    parser.add_argument("--control_general_qwk",                action = "store_true",          help = "general_q") 
    parser.add_argument("--control_biased_general_kwq",                action = "store_true",          help = "biased_general_q") 
    parser.add_argument("--control_biased_general_qwk",                action = "store_true",          help = "biased_general_q") 
    parser.add_argument("--control_act_general_tanh",                action = "store_true",          help = "act_general_tanh") 
    parser.add_argument("--control_act_general_tanh_0",                action = "store_true",          help = "act_general_tanh") 
    parser.add_argument("--control_act_general_relu_kwq",                action = "store_true",          help = "act_general_relu_k") 
    parser.add_argument("--control_act_general_relu_qwk",                action = "store_true",          help = "act_general_relu_q") 
    parser.add_argument("--control_scaled",                action = "store_true",          help = "scaled") 
    parser.add_argument("--control_general_qwk",                action = "store_true",          help = "general q") 
    ...
    parser.add_argument("--read_original",      action = "store_true",          help = "original methal") 
    parser.add_argument("--read_general_kwq",                action = "store_true",          help = "general KWQ") 
    parser.add_argument("--read_dot",                        action = "store_true",          help = "dot-product") 
    parser.add_argument("--read_general_qwk",                action = "store_true",          help = "general QWK") 
    parser.add_argument("--read_biased_general_kwq",                action = "store_true",          help = "biased general KWQ") 
    parser.add_argument("--read_biased_general_qwk",                action = "store_true",          help = "bised general QWK") 
    parser.add_argument("--read_act_general_tanh",                action = "store_true",          help = "act_general_tanh") 
    parser.add_argument("--read_act_general_tanh_0",                action = "store_true",          help = "act_general_tanh") 
    parser.add_argument("--read_act_general_relu_kwq",                action = "store_true",          help = "act_general_relu_k") 
    parser.add_argument("--read_act_general_relu_qwk",                action = "store_true",          help = "act_general_relu_q") 
    parser.add_argument("--read_scaled",                action = "store_true",          help = "scaled") 
